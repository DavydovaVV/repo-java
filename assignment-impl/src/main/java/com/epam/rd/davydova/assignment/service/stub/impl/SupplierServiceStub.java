...
import com.epam.rd.davydova.assignment.domain.stub.SupplierStub;
...
public class SupplierServiceStub implements IService {
    private final SupplierStub supplierStub;
    private final MessageSource messageSource;

    /**
     * Find stubbed value of Supplier in RU or EN
     *
    ...
    public String findAll(String languageTag) {
        var result = messageSource.getMessage("message2",
                new Object[]{supplierStub.getSupplierId(), supplierStub.getCompanyName(), supplierStub.getPhone()},
